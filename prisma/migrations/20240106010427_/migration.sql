...
-- CreateEnum
CREATE TYPE "PermissionCode" AS ENUM ('view', 'create', 'update', 'delete', 'menu');

-- CreateEnum
CREATE TYPE "PermissionGroup" AS ENUM ('groups', 'permissions', 'roles', 'trips', 'groupings', 'drivers', 'aggregates', 'fleets', 'clients', 'trucks', 'trailers');
...
-- CreateEnum
CREATE TYPE "trailer_certificate_types" AS ENUM ('yearly', 'quarterly');
...
CREATE TABLE "fleets" (
    ...
    CONSTRAINT "fleets_pkey" PRIMARY KEY ("company_id")
);
...
CREATE TABLE "trailer_certificates" (
    "id" SERIAL NOT NULL,
    "type" "trailer_certificate_types" NOT NULL,
    "semi_trailer_id" INTEGER NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "trailer_certificates_pkey" PRIMARY KEY ("id","semi_trailer_id")
);
...
-- CreateIndex
CREATE INDEX "people_fleet_id_idx" ON "people"("fleet_id");
...
-- CreateIndex
CREATE INDEX "aggregates_fleet_id_idx" ON "aggregates"("fleet_id");
...
-- CreateIndex
CREATE INDEX "trips_scheduled_idx" ON "trips"("scheduled");
...
-- AddForeignKey
ALTER TABLE "people" ADD CONSTRAINT "people_fleet_id_fkey" FOREIGN KEY ("fleet_id") REFERENCES "fleets"("company_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "aggregates" ADD CONSTRAINT "aggregates_fleet_id_fkey" FOREIGN KEY ("fleet_id") REFERENCES "fleets"("company_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_fleet_id_fkey" FOREIGN KEY ("fleet_id") REFERENCES "fleets"("company_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "trailer_certificates" ADD CONSTRAINT "trailer_certificates_semi_trailer_id_fkey" FOREIGN KEY ("semi_trailer_id") REFERENCES "semi_trailers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "trips" ADD CONSTRAINT "trips_semi_trailer_id_fkey" FOREIGN KEY ("semi_trailer_id") REFERENCES "semi_trailers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "trips" ADD CONSTRAINT "trips_fleet_id_fkey" FOREIGN KEY ("fleet_id") REFERENCES "fleets"("company_id") ON DELETE SET NULL ON UPDATE CASCADE;
