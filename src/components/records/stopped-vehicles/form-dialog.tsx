...
export const FormDialog = ({
  ...
  const form = useForm<z.infer<typeof StoppedVehicleSchema>>({
    ...
    defaultValues: nullAsUndefined(initialData) || { startedAt: new Date() },
  })
  ...
  const { execute } = useAction(create, {
    onSuccess: () => {
      toast({
        title: 'Pausa de veículo registrada com sucesso',
        description:
          'A pausa de veículo de reboque foi registrada com sucesso! 🎉',
      })
    },
    onError: (error) => {
      toast({
        variant: 'destructive',
        title: 'Erro ao registrar a pausa de veículo',
        description: error,
      })
    },
  })
  ...
  const { execute: executeUpdate } = useAction(update, {
    onSuccess: () => {
      toast({
        title: 'Pausa de veículo atualizada com sucesso',
        description: 'A pausa de veículo foi atualizada com sucesso! 🎉',
      })
    },
    onError: (error) => {
      toast({
        variant: 'destructive',
        title: 'Erro ao atualizar a pausa de veículo',
        description: error,
      })
    },
  })
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <DialogHeader>
            <DialogTitle>
              {initialData
                ? 'Registro da pausa de veículo'
                : 'Registro de pausa de veículo'}
            </DialogTitle>

            <DialogDescription>
              {initialData
                ? 'Altere as pausa de veículos'
                : 'Regstre novas pausa de veículos'}
            </DialogDescription>
          </DialogHeader>
